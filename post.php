...
<head>
    ...
    <link href="styles/the-road-ahead.css" rel="stylesheet">   
</head>
...
<body>
    <header class="header">
        ...
        <div class="header-context">
            <h1 class="header-text_title">The Road Ahead</h1>
            <h2 class="header-text_description">The road ahead might be paved - it might not be.</h2>
        </div>
    </header>
    <div class="section">
        ...
        <div class="section-box section_background">
            <div class="section-content">
                    ...
                    It was the masterful and incommunicable wisdom of eternity laughing at the futility
                    ...
                    and formed into crystals of frost. Leather harness was on the dogs, and leather
                    ...
                    The front end of the sled was turned up, like a scroll, in order to force down
                    ...
                    On the sled, in the box, lay a third man whose toil was over,—a man whom the Wild
                    had conquered and beaten down until he would never move nor struggle again.
                    ...
                    and most ferociously and terribly of all does the Wild harry
                    and crush into submission man—man who is the most restless of life,
                    ever in revolt against the dictum that all movement must in the end come
                    ...
                    breath that their faces were not discernible. This gave them the seeming of ghostly masques,
                    undertakers in a spectral world at the funeral of some ghost. But under it all they were men,
                    penetrating the land of desolation and mockery and silence, puny adventurers
                    bent on colossal adventure, pitting themselves against the might of a world as remote
